...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        public static void CreateRounds(TournamentModel model)
        {
            ...
            int byes = NumberOfBuyes(rounds, randomizedTeams.Count);
        ...
        public static void UpdateTounamentResults(TournamentModel model)
        {
        ...
        public static void AlertUsersToNewRound(this TournamentModel model)
        {
            ...
            foreach (MatchupModel matchup in currentRound)
            {
                foreach (MatchupEntryModel me in matchup.Entries)
                {
                    ...
                    {
                        AllertPersonToNewRound(p, me.TeamCompeting.TeamName, 
        ...
        private static void MarkWinnerInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m in models)
            {
                ...
                if (m.Entries.Count == 1)
                {
                    ...
                    //continue foreach to next loop
                    continue;
                }
                
                //false, low score wins
                if (greaterWins == "0")
                {
